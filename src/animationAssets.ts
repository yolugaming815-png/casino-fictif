...
export const ANIMATION_ASSETS = [
  {
    ...
    video: new URL("./assets/animated-lobby/01-hero-duel-16x9.mp4", import.meta.url).href,
    prompt:
  ...
  },
  {
    ...
    video: new URL("./assets/animated-lobby/02-game-dragon-spin-9x16.mp4", import.meta.url).href,
    prompt:
  ...
  },
  {
    ...
    video: new URL("./assets/animated-lobby/03-game-blackjack-9x16.mp4", import.meta.url).href,
    prompt:
  ...
  },
  {
    ...
    video: new URL("./assets/animated-lobby/04-game-roulette-9x16.mp4", import.meta.url).href,
    prompt:
  ...
  },
  {
    ...
    video: new URL("./assets/animated-lobby/05-game-battle-poker-9x16.mp4", import.meta.url).href,
    prompt:
  ...
  },
  {
    ...
    video: new URL("./assets/animated-lobby/06-game-gems-quest-9x16.mp4", import.meta.url).href,
    prompt:
  ...
  },
  {
    ...
    video: new URL("./assets/animated-lobby/07-reward-chest-16x9.mp4", import.meta.url).href,
    prompt:
  ...
  },
  {
    ...
    video: new URL("./assets/animated-lobby/08-promo-friends-16x9.mp4", import.meta.url).href,
    prompt:
  ...
  },
  {
    ...
    video: new URL("./assets/animated-lobby/09-promo-profile-16x9.mp4", import.meta.url).href,
    prompt:
  ...
  },
  {
    ...
    video: new URL("./assets/animated-lobby/10-promo-rewards-16x9.mp4", import.meta.url).href,
    prompt:
  ...
  },
  {
    ...
    video: new URL("./assets/animated-lobby/11-tournament-cup-16x9.mp4", import.meta.url).href,
    prompt:
